...
public class ACE {
	...
	public static void connectACE(PhilosophersStone ace, PhilosophersStone process) {
		PhilosophersStoneUtilities.publiclyConnect(ace, process);
		PhilosophersStoneUtilities.privatelyConnect(process, ace);
	}
}